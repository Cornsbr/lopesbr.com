...
!(function () {
  ...
  i.factory("$$uisDebounce", [
      ...
      function (e, t, s, i, c) {
        return {
          ...
          compile: function (i, n) {
            ...
            u.attr("ng-repeat", o.repeatExpression(l)).attr(
              "ng-if",
              "$select.open"
            );
            ...
            return (
              ...
              function (t, s, c, n) {
                n.parseRepeatAttr(c.repeat, l, a),
                  (n.disableChoiceExpression = c.uiDisableChoice),
                  (n.onHighlightCallback = c.onHighlight),
                  (n.minimumInputLength = parseInt(c.minimumInputLength) || 0),
                  (n.dropdownPosition = c.position
                  ...
                  t.$watch("$select.search", function (e) {
                    e && !n.open && n.multiple && n.activate(!1, !0),
                      ...
                      n.search.length >= c.minimumInputLength
                        ? n.refresh(c.refresh)
                        : (n.items = []);
                  }),
                  ...
                  t.$watch("$select.open", function (e) {
                    e
                      ? (i.attr("role", "listbox"), n.refresh(c.refresh))
                      : s.removeAttr("role");
                  });
              }
            );
    ...
    i.controller("uiSelectCtrl", [
      ...
      "$injector",
      "$window",
      function (s, i, c, n, l, a, r, o, u, d, p) {
        function h(e, t, s) {
          ...
          if (e) {
            ...
            y.isLocked = function (e, i) {
              ...
              return (
                n &&
                  (e
                    ? ((c = !!e.$eval(y.lockChoiceExpression)), t(n, c))
                    : (c = s(n))),
                c
              );
            };
          ...
          switch (e) {
            ...
            case t.UP:
              ...
              if (!y.open && y.multiple) y.activate(!1, !0);
                ...
                for (var n = --y.activeIndex; m(y.items[n]) && n > c; )
                  y.activeIndex = --n;
              break;
            case t.TAB:
              ...
              break;
            case t.ENTER:
              y.open && (y.tagging.isActivated || y.activeIndex >= 0)
                ? y.select(y.items[y.activeIndex], y.skipFocusser)
                : y.activate(!1, !0);
              break;
            case t.ESC:
              y.close();
        ...
        function w() {
          ...
          if (!(y.activeIndex < 0)) {
            ...
            c > n
              ? (e[0].scrollTop += c - n)
              : c < s.clientHeight &&
                (y.isGrouped && 0 === y.activeIndex
                  ? (e[0].scrollTop = 0)
                  : (e[0].scrollTop -= s.clientHeight - c));
          }
        }
        var y = this,
          x = "";
        if (
          ((y.placeholder = o.placeholder),
          (y.searchEnabled = o.searchEnabled),
          (y.sortable = o.sortable),
          (y.refreshDelay = o.refreshDelay),
          (y.paste = o.paste),
          (y.resetSearchInput = o.resetSearchInput),
          (y.refreshing = !1),
          (y.spinnerEnabled = o.spinnerEnabled),
          (y.spinnerClass = o.spinnerClass),
          (y.removeSelected = o.removeSelected),
          (y.closeOnSelect = !0),
          (y.skipFocusser = !1),
          (y.search = x),
          (y.activeIndex = 0),
          ...
          (y.disabled = !1),
          (y.selected = void 0),
          (y.dropdownPosition = "auto"),
          (y.focusser = void 0),
          (y.multiple = void 0),
          (y.disableChoiceExpression = void 0),
          (y.tagging = { isActivated: !1, fct: void 0 }),
          (y.taggingTokens = { isActivated: !1, tokens: void 0 }),
          (y.lockChoiceExpression = void 0),
          (y.clickTriggeredSelect = !1),
          (y.$filter = n),
          (y.$element = i),
          (y.$animate = (function () {
            try {
          ...
          (y.searchInput = i.querySelectorAll("input.ui-select-search")),
          1 !== y.searchInput.length)
        )
          throw r(
            "searchInput",
            "Expected 1 input.ui-select-search but got '{0}'.",
            y.searchInput.length
          );
        (y.isEmpty = function () {
          return (
            e(y.selected) ||
            "" === y.selected ||
            (y.multiple && 0 === y.selected.length)
          );
        }),
          (y.activate = function (e, t) {
            if (y.disabled || y.open) y.open && !y.searchEnabled && y.close();
              ...
              t || g(),
                s.$broadcast("uis:activate"),
                (y.open = !0),
                (y.activeIndex =
                  y.activeIndex >= y.items.length ? 0 : y.activeIndex),
                y.activeIndex === -1 &&
                  y.taggingLabel !== !1 &&
                  (y.activeIndex = 0);
              ...
              if (y.$animate && y.$animate.on && y.$animate.enabled(n[0])) {
                var a = function (t, s) {
                  "start" === s && 0 === y.items.length
                    ? (y.$animate.off("removeClass", l[0], a),
                      c(function () {
                        y.focusSearchInput(e);
                      }))
                    : "close" === s &&
                      (y.$animate.off("enter", n[0], a),
                      c(function () {
                        y.focusSearchInput(e);
                      }));
                };
                y.items.length > 0
                  ? y.$animate.on("enter", n[0], a)
                  : y.$animate.on("removeClass", l[0], a);
              } else
                c(function () {
                  y.focusSearchInput(e),
                    !y.tagging.isActivated && y.items.length > 1 && w();
                });
            }
          }),
          ...
          (y.parseRepeatAttr = function (e, t, i) {
            function c(e) {
              ...
              if (
                ...
                angular.isFunction(n)
                  ? (y.groups = n(y.groups))
                  : angular.isArray(n) && (y.groups = f(y.groups, n));
              }
              (y.items = []),
                y.groups.forEach(function (e) {
            ...
            (y.setItemsFn = t ? c : n),
              (y.parserResult = a.parse(e)),
              (y.isGrouped = !!t),
              (y.itemProperty = y.parserResult.itemName);
            ...
            y.parserResult.keyName &&
              (o(),
              (y.parserResult.source = u(
                "$uisSource" + y.parserResult.filters
              )),
              s.$watch(
                l,
                function (e, t) {
              ...
              (y.refreshItems = function (e) {
                e = e || y.parserResult.source(s);
                var t = y.selected;
                if (
                  y.isEmpty() ||
                  (angular.isArray(t) && !t.length) ||
                  !y.multiple ||
                  !y.removeSelected
                )
                  y.setItemsFn(e);
                ...
                ("auto" !== y.dropdownPosition &&
                  "up" !== y.dropdownPosition) ||
                  s.calculateDropdownPos(),
                  s.$broadcast("uis:refresh");
              }),
              s.$watchCollection(y.parserResult.source, function (e) {
                if (void 0 === e || null === e) y.items = [];
                else {
                  if (!angular.isArray(e))
                    throw r("items", "Expected an array but got '{0}'.", e);
                  y.refreshItems(e),
                    angular.isDefined(y.ngModel.$modelValue) &&
                      (y.ngModel.$modelValue = null);
                }
              });
          });
        var E;
        (y.refresh = function (e) {
          ...
          (y.isActive = function (e) {
            ...
            return (
              !(!s || t < 0) &&
              (s &&
                !angular.isUndefined(y.onHighlightCallback) &&
                e.$eval(y.onHighlightCallback),
              s)
            );
          });
        var S = function (e) {
            return (
              y.selected &&
              angular.isArray(y.selected) &&
              y.selected.filter(function (t) {
        ...
        (y.isDisabled = function (e) {
          if (y.open) {
            ...
            if (
              s >= 0 &&
              (angular.isDefined(y.disableChoiceExpression) || y.multiple)
            ) {
              if (t.isTag) return !1;
              y.multiple && (i = S(t)),
                !i &&
                  angular.isDefined(y.disableChoiceExpression) &&
                  (i = !!e.$eval(y.disableChoiceExpression)),
                v(t, i);
            }
            return i;
          }
            ...
            if (e(t) || !m(t)) {
              ...
              if (!t || !m(t)) {
                if (
                  ((y.clickTriggeredSelect = !1),
                  c &&
                    ("click" === c.type || "touchend" === c.type) &&
                    t &&
                    (y.clickTriggeredSelect = !0),
                  y.tagging.isActivated && y.clickTriggeredSelect === !1)
                ) {
                  if (y.taggingLabel === !1)
                    if (y.activeIndex < 0) {
                      if (
                        (void 0 === t &&
                          (t =
                            void 0 !== y.tagging.fct
                              ? y.tagging.fct(y.search)
                              : y.search),
                        !t || angular.equals(y.items[0], t))
                      )
                        return;
                    ...
                    if (void 0 !== y.tagging.fct && "string" == typeof t) {
                      ...
                      "string" == typeof t &&
                        (t = t.replace(y.taggingLabel, "").trim());
                  }
                  if (S(t)) return void y.close(i);
                }
                g(),
                  s.$broadcast("uis:select", t),
                  y.closeOnSelect && y.close(i);
              }
            }
          }),
          (y.close = function (e) {
            y.open &&
              (y.ngModel && y.ngModel.$setTouched && y.ngModel.$setTouched(),
              (y.open = !1),
              g(),
              s.$broadcast("uis:close", e));
          }),
          (y.setFocus = function () {
          ...
          (y.toggle = function (e) {
            y.open
              ? (y.close(), e.preventDefault(), e.stopPropagation())
              : y.activate();
          }),
          (y.isLocked = function () {
            return !1;
          ...
          s.$watch(function () {
            return (
              angular.isDefined(y.lockChoiceExpression) &&
              "" !== y.lockChoiceExpression
            );
          }, $);
        var C = null,
          k = !1;
        (y.sizeSearchInput = function () {
          var e = y.searchInput[0],
            ...
            n = function (t) {
              ...
              return (
                s < 50 && (s = t), y.searchInput.css("width", s + "px"), !0
              );
            };
          y.searchInput.css("width", "10px"),
            c(function () {
              null !== C ||
                n(i()) ||
                (C = s.$watch(function () {
          ...
          y.searchInput.on("keydown", function (e) {
            var i = e.which;
            ~[t.ENTER, t.ESC].indexOf(i) &&
              (e.preventDefault(), e.stopPropagation()),
              s.$apply(function () {
                var s = !1;
                if (
                  (y.items.length > 0 || y.tagging.isActivated) &&
                  (b(i) ||
                    y.searchEnabled ||
                    (e.preventDefault(), e.stopPropagation()),
                  y.taggingTokens.isActivated)
                ) {
                  for (var n = 0; n < y.taggingTokens.tokens.length; n++)
                    y.taggingTokens.tokens[n] === t.MAP[e.keyCode] &&
                      y.search.length > 0 &&
                      (s = !0);
                  s &&
                    c(function () {
                      ...
                      y.tagging.fct && (s = y.tagging.fct(s)),
                        s && y.select(s, !0);
                    });
                }
              }),
              t.isVerticalMovement(i) && y.items.length > 0 && w(),
              (i !== t.ENTER && i !== t.ESC) ||
                (e.preventDefault(), e.stopPropagation());
          }),
          y.searchInput.on("paste", function (e) {
            ...
            if (
              ...
              if (y.taggingTokens.isActivated) {
                for (
                  var i = [], c = 0;
                  c < y.taggingTokens.tokens.length;
                  c++
                ) {
                  var n =
                    t.toSeparator(y.taggingTokens.tokens[c]) ||
                    y.taggingTokens.tokens[c];
                  if (s.indexOf(n) > -1) {
                    i = s.split(n);
                    break;
                  }
        ...
        angular.element(p).bind("resize", A),
          s.$on("$destroy", function () {
            y.searchInput.off("keyup keydown tagged blur paste"),
              angular.element(p).off("resize", A);
          }),
            ...
            e &&
              i
                ...
                .attr(
                  ...
                  "ui-select-choices-row-" + y.generatedId + "-" + e
                );
          }),
          ...
          compile: function (c, a) {
            ...
            return (
              angular.isDefined(a.multiple)
                ? c.append("<ui-select-multiple/>").removeAttr("multiple")
                : c.append("<ui-select-single/>"),
              a.inputId &&
              ...
              function (c, a, r, o, u) {
                ...
                (g.generatedId = t.generateId()),
                  ...
                  r.$observe("spinnerClass", function () {
                    ...
                    g.spinnerClass =
                      void 0 !== e ? r.spinnerClass : t.spinnerClass;
                  }),
                  ...
                  u(c, function (e) {
                    ...
                    if (
                      (c.removeAttr("ui-select-choices"),
                      c.removeAttr("data-ui-select-choices"),
                      1 !== c.length)
                    )
                      throw s(
                        "transcluded",
                ...
                (void 0 !== v ? v : t.appendToBody) &&
                  (c.$watch("$select.open", function (e) {
                    e ? p() : h();
                  }),
                  c.$on("$destroy", function () {
                    h();
                ...
                c.$watch("$select.open", function () {
                  ("auto" !== g.dropdownPosition &&
                    ...
                    c.calculateDropdownPos();
                });
                var y = function (e, t) {
                    (e = e || i(a)),
                      (t = t || i(b)),
                      (b[0].style.position = "absolute"),
                      (b[0].style.top = t.height * -1 + "px"),
                      a.addClass(w);
                  },
                  x = function (e, t) {
                    a.removeClass(w),
                      ...
                      if ("up" === g.dropdownPosition) y();
                        ...
                        var t = i(a),
                          ...
                          c =
                            ...
                            e[0].body.scrollTop;
                        t.top + t.height + s.height >
                        c + e[0].documentElement.clientHeight
                          ? y(t, s)
                          : x(t, s);
                      }
                      b[0].style.opacity = 1;
      ...
      function (e) {
        ...
        return {
          ...
          link: function (t, s, i, c) {
            ...
            (c.lockChoiceExpression = i.uiLockChoice),
              i.$observe("placeholder", function (t) {
                c.placeholder = void 0 !== t ? t : e.placeholder;
              }),
              i.$observe("allowClear", n),
              n(i.allowClear),
              c.multiple && c.sizeSearchInput();
          },
        };
      },
    ]),
          ...
          controller: [
            ...
            function (e, t) {
              var s,
                i = this,
                c = e.$select;
              angular.isUndefined(c.selected) && (c.selected = []),
                ...
                (i.refreshComponent = function () {
                  c.refreshItems && c.refreshItems(),
                    c.sizeSearchInput && c.sizeSearchInput();
                }),
                (i.removeChoice = function (s) {
                  ...
                  var n = c.selected[s],
                    l = {};
                  return (
                    (l[c.parserResult.itemName] = n),
                    c.selected.splice(s, 1),
                    (i.activeMatchIndex = -1),
                    c.sizeSearchInput(),
                    t(function () {
          ...
          link: function (c, n, l, a) {
            ...
            function o(e) {
              ...
              var i = r(p.searchInput[0]),
                ...
                d = a;
              return (
                !(i > 0 || (p.search.length && e == t.RIGHT)) &&
                (p.close(),
                (d = s()),
                p.selected.length && d !== !1
                  ? (g.activeMatchIndex = Math.min(l, Math.max(n, d)))
            ...
            function u(e) {
              ...
              var t =
                e.filter(function (e) {
                  return (
                    void 0 !== p.search.toUpperCase() &&
                    void 0 !== e &&
                    e.toUpperCase() === p.search.toUpperCase()
                  );
                }).length > 0;
              return t;
            }
              ...
              if (angular.isArray(e))
                for (var i = angular.copy(e), c = 0; c < i.length; c++)
                  if (void 0 === p.tagging.fct)
                    i[c] + " " + p.taggingLabel === t && (s = c);
                  else {
                    var n = i[c];
                    angular.isObject(n) && (n.isTag = !0),
                      angular.equals(n, t) && (s = c);
                  }
              return s;
            }
            var p = a[0],
              ...
              g = c.$selectMultiple;
            (p.multiple = !0),
              (p.focusInput = p.searchInput),
              (h.$isEmpty = function (e) {
                return !e || 0 === e.length;
              }),
              h.$parsers.unshift(function () {
                for (
                  var e, t = {}, s = [], i = p.selected.length - 1;
                  i >= 0;
                  i--
                )
                  (t = {}),
                    (t[p.parserResult.itemName] = p.selected[i]),
                    (e = p.parserResult.modelMapper(c, t)),
                    s.unshift(e);
                return s;
              }),
              h.$formatters.unshift(function (e) {
                var t,
                  s =
                    p.parserResult &&
                    p.parserResult.source(c, { $select: { search: "" } }),
                  i = {};
                if (!s) return e;
                var n = [],
                  l = function (e, s) {
                    if (e && e.length) {
                      for (var l = e.length - 1; l >= 0; l--) {
                        if (
                          ((i[p.parserResult.itemName] = e[l]),
                          (t = p.parserResult.modelMapper(c, i)),
                          ...
                          if (
                            a &&
                            a.length > 0 &&
                            a[1] == p.parserResult.itemName &&
                            r &&
                            r.length > 0 &&
                            t[r[1]] == s[r[1]]
                          )
                            return n.unshift(e[l]), !0;
                        }
              ...
              c.$watchCollection(
                ...
                function (e, t) {
                  t != e &&
                    (angular.isDefined(h.$modelValue) && (h.$modelValue = null),
                    g.refreshComponent());
                }
              ),
              (h.$render = function () {
              ...
              p.searchInput.on("keydown", function (e) {
                ...
                c.$apply(function () {
                  var i = !1;
                  t.isHorizontalMovement(s) && (i = o(s)),
                    i &&
                      s != t.TAB &&
                      (e.preventDefault(), e.stopPropagation());
                });
              ...
              p.searchInput.on("keyup", function (e) {
                if (
                  ...
                  if (void 0 !== p.tagging.fct) {
                    ...
                    if (
                      ((n = p.$filter("filter")(a, function (e) {
                      ...
                      void 0 !== i &&
                        ...
                        (a = a.slice(1, a.length)),
                        (r = r.slice(1, r.length))),
                      (s = p.search + " " + p.taggingLabel),
                      d(p.selected, p.search) > -1)
                    )
                      return;
                    if (u(r.concat(p.selected)))
                      return void (
                        o &&
                        ((a = r),
                        c.$evalAsync(function () {
                    ...
                    if (u(r))
                      return void (o && (p.items = r.slice(1, r.length)));
                  }
                  o && (h = d(p.selected, s)),
                    h > -1
                      ? (a = a.slice(h + 1, a.length - 1))
                      : ((a = []), s && a.push(s), (a = a.concat(r))),
                    c.$evalAsync(function () {
          ...
          link: function (c, n, l, a) {
            ...
            o.$parsers.unshift(function (t) {
              ...
              var s,
                i = {};
              return (
                (i[r.parserResult.itemName] = t),
                (s = r.parserResult.modelMapper(c, i))
              );
            }),
              o.$formatters.unshift(function (t) {
                ...
                var s,
                  i =
                    r.parserResult &&
                    r.parserResult.source(c, { $select: { search: "" } }),
                  n = {};
                if (i) {
                  var l = function (e) {
                    return (
                      (n[r.parserResult.itemName] = e),
                      (s = r.parserResult.modelMapper(c, n)),
                      s === t
                    );
                  };
            ...
            i(u)(c),
              ...
              u.bind("keydown", function (e) {
                return e.which === t.BACKSPACE && r.backspaceReset !== !1
                  ? (e.preventDefault(),
                    e.stopPropagation(),
                    r.select(void 0),
                    void c.$apply())
                  : void (
                      ...
                      ((e.which != t.DOWN &&
                        ...
                        e.which != t.ENTER &&
                        e.which != t.SPACE) ||
                        (e.preventDefault(), e.stopPropagation(), r.activate()),
                      c.$digest())
                    );
              }),
              u.bind("keyup input", function (e) {
                e.which === t.TAB ||
                  ...
                  e.which == t.ENTER ||
                  e.which === t.BACKSPACE ||
                  (r.activate(u.val()), u.val(""), c.$digest());
              });
          },
        };
      },
      ...
      function (e, t, s) {
        return {
          ...
          link: function (t, i, c, n) {
            if (null === t[c.uiSelectSort])
              throw s("sort", "Expected a list to sort");
            var l = n[0],
              a = n[1],
              r = angular.extend(
                { axis: "horizontal" },
            ...
            i.on("dragenter", function () {
              i.hasClass(u) ||
                (i.addClass(d), i.on("dragover", m), i.on("drop", $));
            }),
              i.on("dragleave", function (e) {
                e.target == i &&
                  (v(d), v(p), v(h), i.off("dragover", m), i.off("drop", $));
              });
          },
        };
      },
    ]),
    i.directive("uisOpenClose", [
      "$parse",
      "$timeout",
      function (e, t) {
        return {
          ...
          link: function (s, i, c, n) {
            (n.onOpenCloseCallback = e(c.uisOpenClose)),
              s.$watch("$select.open", function (e, i) {
                e !== i &&
                  t(function () {
