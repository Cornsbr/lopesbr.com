...
(function (R, C) {
  ...
  function W(a, b, c) {
    ...
    c.preparationClasses &&
      ((d.preparationClasses = Z(c.preparationClasses, d.preparationClasses)),
  ...
  var Q = C.noop,
    ...
    $,
    ya;
  I(R.ontransitionend) && ea(R.onwebkittransitionend)
    ? ((S = "WebkitTransition"), (xa = "webkitTransitionEnd transitionend"))
    : ((S = "transition"), (xa = "transitionend"));
  I(R.onanimationend) && ea(R.onwebkitanimationend)
    ? (($ = "WebkitAnimation"), (ya = "webkitAnimationEnd animationend"))
    : (($ = "animation"), (ya = "animationend"));
  var qa = $ + "Delay",
    za = $ + "Duration",
    ma = S + "Delay",
    La = S + "Duration",
      ...
      function (a) {
        return {
          link: function (b, c, d) {
            ...
            C.isString(l) && 0 === l.length
              ? c.data("$$ngAnimateChildren", !0)
              : (e(a(l)(b)), d.$observe("ngAnimateChildren", e));
          },
        };
      },
    ])
        ...
        this.$get = [
          ...
          function (b, c, g, l, v, Wa, P, t, F, T) {
            ...
            function y(a, b, c) {
              ...
              (a = h[c]) &&
                s(a, function (a) {
                  x.call(a.node, f)
                    ? N.push(a.callback)
                    : "leave" === c && x.call(a.node, d) && N.push(a.callback);
                });
              return N;
            }
            function r(a, b, c) {
            ...
            function p(a, h, w) {
              ...
              w = (!t && A.get(p)) || {};
              var F = !!w.state;
              t || (F && 1 == w.state) || (t = !M(a, T, h));
              if (t)
                return x && r(B, h, "start"), k(), x && r(B, h, "close"), B;
              g && K(a);
              x = {
                structural: g,
                element: a,
              ...
              (F = x.structural) ||
                (F =
                  ("animate" === x.event &&
                    0 < Object.keys(x.options.to || {}).length) ||
                  e(x));
              ...
              c.$$postDigest(function () {
                ...
                if (c || b.counter !== v || !f) {
                  ...
                  (h = !b.structural && e(b, !0) ? "setClass" : b.event),
                    L(a, 2),
                    (b = Wa(a, h, b.options)),
                    B.setHost(b),
                    r(B, h, "start", {}),
            ...
            function M(a, b, c) {
              ...
              for (b = z(b); b; ) {
                ...
                if (I(r) || !0 === r)
                  (a = G.data(b, "$$ngAnimateChildren")), ea(a) && (r = a);
                if (h && !1 === r) break;
                f || (f = k(b, c));
                if (f && d) break;
        ...
        this.$get = [
          ...
          function (a, e, l, n, H, g, u, v) {
            function C(a, b) {
              var c = a.parentNode;
              return (
                (c.$$ngAnimateParentKey || (c.$$ngAnimateParentKey = ++J)) +
                "-" +
            ...
            function P(r, p, g, n) {
              ...
              0 < b.count(g) &&
                ...
                k ||
                  ...
                  e.addClass(r, p),
                  (k = Fa(a, r, n)),
                  (k.animationDuration = Math.max(k.animationDuration, 0)),
                  (k.transitionDuration = Math.max(k.transitionDuration, 0)),
                  e.removeClass(r, p),
                  c.put(g, k)));
              return k || {};
            }
            ...
            return function (a, c) {
                ...
                function b() {
                  if (!x) {
                    ...
                    q.applyAnimationDelay &&
                      ((aa =
                        "boolean" !== typeof f.delay && ua(f.delay)
                          ? parseFloat(f.delay)
                          : aa),
                      (O = Math.max(aa, 0)),
                      (D.animationDelay = aa),
                    ...
                    if (g.length) {
                      var l = g[0];
                      (N = d > l.expectedEndTime)
                        ? n.cancel(l.timer)
                        : g.push(k);
                    }
                    N &&
                      ((p = n(c, p, !1)),
                      (g[0] = { timer: p, expectedEndTime: d }),
                      g.push(k),
                      a.data("$$animateCss", g));
                    if (fa.length) a.on(fa.join(" "), A);
                    f.to &&
                      (f.cleanupStyles && Ia(B, h, Object.keys(f.to)),
                      Da(a, f));
                  }
                }
                function c() {
                ...
                if (!x)
                  if (h.parentNode) {
                    var d = function (a) {
                      ...
                      g =
                        0 < da &&
                        ((D.transitionDuration && 0 === X.transitionDuration) ||
                          (D.animationDuration && 0 === X.animationDuration)) &&
              ...
              f.removeClass &&
                (U.length && (U += " "), (U += Y(f.removeClass, "-remove")));
              ...
              f.transitionStyle &&
                ((E = [S, f.transitionStyle]), la(h, E), y.push(E));
              0 <= f.duration &&
                ((E = 0 < h.style[S].length),
                (E = Ga(f.duration, E)),
                la(h, E),
                y.push(E));
              f.keyframeStyle &&
                ((E = [$, f.keyframeStyle]), la(h, E), y.push(E));
              var da = X
                ? 0 <= f.staggerIndex
                  ? f.staggerIndex
                  : b.count(ia)
              ...
              q.hasAnimations = 0 < D.animationDuration;
              q.hasTransitionAll =
                q.hasTransitions && "all" == D.transitionProperty;
              ...
              if (q.applyTransitionDuration || q.applyAnimationDuration)
                (m = f.duration ? parseFloat(f.duration) : m),
                  q.applyTransitionDuration &&
                    ((q.hasTransitions = !0),
                    (D.transitionDuration = m),
                    (E = 0 < h.style[S + "Property"].length),
                    y.push(Ga(m, E))),
                  q.applyAnimationDuration &&
                    ((q.hasAnimations = !0),
                    (D.animationDuration = m),
                    y.push([za, m + "s"]));
              if (0 === m && !q.recalculateTimingStyles) return L();
              if (null != f.delay) {
                var ba;
                "boolean" !== typeof f.delay &&
                  ((ba = parseFloat(f.delay)), (O = Math.max(ba, 0)));
              ...
              V = 1e3 * m;
              f.skipBlocking ||
                ((q.blockTransition = 0 < D.transitionDuration),
                (q.blockKeyframeAnimation =
                  0 < D.animationDuration &&
                  0 < X.animationDelay &&
                  0 === X.animationDuration));
              f.from &&
                (f.cleanupStyles && Ia(B, h, Object.keys(f.from)), Ca(a, f));
              q.blockTransition || q.blockKeyframeAnimation
                ? M(m)
                : f.skipBlocking || pa(h, !1);
              return {
                $$willAnimate: !0,
                end: d,
                start: function () {
                  if (!x)
                    return (
                      (w = { end: d, cancel: u, resume: null, pause: null }),
                      (I = new l(w)),
                      t(N),
                      I
                    );
      ...
      function (a) {
        ...
        this.$get = [
          ...
          function (a, c, d, e, l, n, H) {
            ...
            c = z(e);
            var F = G(
              (c.parentNode && 11 === c.parentNode.nodeType) || t.contains(c)
                ? c
                : t
            );
            V(n);
            return function (a) {
              return a.from && a.to
                ? C(a.from, a.to, a.classes, a.anchors)
                : P(a);
            };
          },
        ];
            ...
            return function (a, b, d, u) {
              ...
              function t(a, b, d, e, f) {
                ...
                if (0 === g.length) {
                  var h, k;
                  "beforeSetClass" === f
                    ? ((h = z(a, "removeClass", d, e, "beforeRemoveClass")),
                      (k = z(a, "addClass", d, e, "beforeAddClass")))
                    : "setClass" === f &&
                      ((h = z(a, "removeClass", d, e, "removeClass")),
                      (k = z(a, "addClass", d, e, "addClass")));
                  h && (g = g.concat(h));
                  k && (g = g.concat(k));
                }
                if (0 !== g.length)
