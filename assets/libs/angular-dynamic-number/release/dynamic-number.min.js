!(function (n, e) {
  ...
  function g(n) {
    return String(n)
      ...
      .replace(/^0(\d+)/g, "$1")
      .replace(/^-0(\d+)/g, "-$1")
      .replace(new RegExp("^-([\\.,\\s])", "g"), "-0$1")
      .replace(new RegExp("^[\\.,\\s]", "g"), "0$&");
  }
  function v(n, e, t) {
    var r = n;
    return (
      e && (r = r.replace(new RegExp("[\\" + e + "]", "g"), "")),
  ...
  function S(n, e) {
    return "." === e
      ...
      : "," === e
      ? String(n).replace(/,/g, "")
      : String(n).replace(new RegExp("['\\s]", "g"), "");
  }
  function h(n, e, t) {
    return (
      (n = String(n).split(e)),
      (n[0] = n[0].replace(/\B(?=(\d{3})+(?!\d))/g, t)),
      n.join(e)
    );
  }
  function w(n, e) {
  ...
  function x(e, t, u, a, i) {
    ...
    var o = String(t),
      ...
      p = n.version;
    1 === p.major && 2 === p.minor ? (e.$viewValue = d) : e.$setViewValue(d),
      e.$render();
  }
  function $(n, t, u, a, i, o, c, d, p) {
    ...
    if (((n = Number(n)), !isNaN(n) && isFinite(n))) {
      ...
      return (
        (n = i
          ? e((a(n * m) / m).toFixed(t), u, d, p)
          : e(String(a(n * m) / m), u, d, p)),
        (n = r(n, d, p)),
        o && (n = h(n, u, c)),
        n
      );
  ...
  function N(n, e) {
    if (null !== n)
      if (n.createTextRange) {
        ...
        n.selectionStart ? (n.focus(), n.setSelectionRange(e, e)) : n.focus();
  }
  function P(n, e, t) {
  ...
  function R(n, e) {
    ...
    return (
      a &&
        a.length > e.fractionPart &&
        ((a = a.slice(0, e.fractionPart)),
        (t = [u, a].join(e.fractionSeparator))),
      t
    );
  }
  function T(n) {
  ...
  function y(n, e) {
    return n.replace(
      new RegExp("[\\" + e.fractionSeparator + "]+", "g"),
      e.fractionSeparator
    );
  }
  function E(n, e, t, r, g) {
    ...
    var S = u(void 0 !== n.numInt ? n.numInt : v.numInt, 6),
      ...
      P = s(
        void 0 !== n.numThousandSep ? n.numThousandSep : v.numThousandSep,
        w,
        "." === w ? "," : "."
      ),
  ...
  function A(n, r, u) {
    ...
    if ((($ = R($, r)), o.test($) === !1)) {
      ...
      return (
        s && (I = h(I, d, f)), x(i, I, r, u), N(a[0], b - 1), i.$modelValue
      );
    }
    var M = 0,
      V = E.length;
      ...
      link: function (e, t, r, u) {
        ...
        t.on("paste", function () {
          ...
          e.$watch("numThousandSep", function (i, o) {
            o !== i &&
              ((a = E(b(e, "numThousandSep", i), t, r, u, n)), M(u, a));
          }),
  ...
  return (
    n
      ...
      .provider("dynamicNumberStrategy", function () {
        ...
        (this.addStrategy = n),
          (this.getStrategy = e),
          (this.getStrategies = t);
        var u = { addStrategy: n, getStrategy: e, getStrategies: t };
        this.$get = function () {
          return u;
        };
      })
      ...
      .directive("awnum", ["dynamicNumberStrategy", V]),
    k
  );
});
