!(function (n) {
  ...
  function E(n, e, i, t) {
    ...
    return (
      --e < 0 ? ((e += Z), (r = 0)) : ((r = Math.ceil((e + 1) / Z)), (e %= Z)),
      (o = w(10, Z - e)),
      (s = n[r] % o | 0),
      null == t
        ? e < 3
  ...
  (f.absoluteValue = f.abs =
    ...
    (f.comparedTo = f.cmp =
      function (n) {
        ...
        for (e = 0, i = (u = r.length) < (t = s.length) ? u : t; e < i; ++e)
          ...
          ? i.d[0]
            ? ((n = t.precision),
              ...
              (i = (function (n, e) {
                ...
                t =
                  (t = e.d.length) < 32
                    ? ((i = Math.ceil(t / 3)), (1 / U(4, i)).toString())
          ...
          if (
            ...
            if ("9999" != (i = i.slice(o - 3, o + 1)) && (r || "4999" != i)) {
              (+i && (+i.slice(1) || "5" != i.charAt(0))) ||
                (_(t, n + 1, 1), (e = !t.times(t).times(t).eq(h)));
              break;
            }
    ...
    (f.decimalPlaces = f.dp =
      function () {
        var n,
          ...
          i = NaN;
        if (e) {
          if (((i = ((n = e.length - 1) - A(this.e / Z)) * Z), (n = e[n])))
            for (; n % 10 == 0; n /= 10) i--;
          i < 0 && (i = 0);
        }
        return i;
    ...
    (f.hyperbolicCosine = f.cosh =
      function () {
        ...
        for (
          ...
          (s = u.times(u)), (u = r.minus(s.times(f.minus(s.times(f)))));
        ...
        return i.isFinite()
          ? i.isZero()
            ...
            : ((n = t.precision),
              ...
              (t.precision = n + 7),
              (t.rounding = 1),
              y(i.sinh(), i.cosh(), (t.precision = n), (t.rounding = e)))
          : new t(i.s);
      }),
        ...
        return t.isZero()
          ...
          : ((n = t.abs().cmp(1)),
            ...
            -1 !== n
              ...
              : ((r.precision = e + 6),
                (r.rounding = 1),
                (t = t.div(new r(1).minus(t.times(t)).sqrt().plus(1)).atan()),
                (r.precision = e),
                (r.rounding = i),
                t.times(2)));
      }),
    (f.inverseTangent = f.atan =
      function () {
        ...
        if (f.isFinite()) {
          ...
          if (a + 4 <= d) return ((o = D(h, a + 4, l).times(0.5)).s = f.s), o;
        }
        for (
          h.precision = u = a + 10,
            h.rounding = 1,
    ...
    (f.logarithm = f.log =
      function (n) {
        ...
        if (null == n) (n = new h(10)), (e = !0);
          ...
          if (((i = (n = new h(n)).d), n.s < 0 || !i || !i[0] || n.eq(1)))
            return new h(NaN);
          e = n.eq(10);
        }
        if (((i = f.d), f.s < 0 || !i || !i[0] || f.eq(1)))
          return new h(i && !i[0] ? -1 / 0 : 1 != f.s ? NaN : i ? 0 : 1 / 0);
        if (e)
          if (1 < i.length) s = !0;
          else {
    ...
    (f.minus = f.sub =
      function (n) {
        ...
        if (
          ((i = A(n.e / Z)), (l = A(l.e / Z)), (f = f.slice()), (s = l - i))
        ) {
          for (
            o = (h = s < 0)
              ? ((e = f), (s = -s), a.length)
    ...
    (f.plus = f.add =
      function (n) {
        ...
        if (
          ((h = A(f.e / Z)), (f = A(n.e / Z)), (u = u.slice()), (t = h - f))
        ) {
          for (
            (r =
              (r =
                t < 0
                  ? ((i = u), (t = -t), c.length)
                  : ((i = c), (f = h), u.length)) < (h = Math.ceil(s / Z))
                ? h + 1
    ...
    (f.precision = f.sd =
      function (n) {
        ...
        return (
          this.d
            ? ((e = W(this.d)), n && this.e + 1 > e && (e = this.e + 1))
            : (e = NaN),
          e
        );
      }),
    ...
    (f.squareRoot = f.sqrt =
      function () {
        var n,
          ...
          h = o.constructor;
        if (1 !== f || !u || !u[0])
          return new h(!f || (f < 0 && (!u || u[0])) ? NaN : u ? o : 1 / 0);
        for (
          N = !1,
            t =
              0 == (f = Math.sqrt(+o)) || f == 1 / 0
                ? (((e = b(u)).length + c) % 2 == 0 && (e += "0"),
                  (f = Math.sqrt(e)),
                  (c = A((c + 1) / 2) - (c < 0 || c % 2)),
                  new h(
                    (e =
        ...
        return i.isFinite()
          ? i.isZero()
            ...
            : ((n = t.precision),
              ...
              (t.rounding = 1),
              ((i = i.sin()).s = 1),
              (i = y(i, new t(1).minus(i.times(i)).sqrt(), n + 10, 0)),
              (t.precision = n),
              (t.rounding = e),
    ...
    (f.toFraction = function (n) {
      ...
      return (
        ...
        (u.s = c.s = a.s),
        (l =
          y(c, t, s, 1).minus(a).abs().cmp(y(u, i, s, 1).minus(a).abs()) < 1
            ? [c, t]
            : [u, i]),
        (d.precision = f),
        (N = !0),
    ...
    (f.toNearest = function (n, e) {
      ...
      if (null == n) {
        ...
        if (
          ((n = new i(n)), void 0 === e ? (e = i.rounding) : v(e, 0, 8), !t.d)
        )
          return n.s ? t : n;
      ...
      return (
        n.d[0]
          ? ((N = !1), (t = y(t, n, 0, e, 1).times(n)), (N = !0), _(t))
          : ((n.s = t.s), (t = n)),
        t
      );
    }),
    ...
    (f.toPower = f.pow =
      function (n) {
        ...
        if (
          ...
          return (r = J(c, u, i, t)), n.s < 0 ? new c(1).div(r) : _(r, t, s);
        if ((o = u.s) < 0) {
        ...
        return (e =
          0 != (i = w(+u, f)) && isFinite(i)
            ? new c(i + "").e
            : A(f * (Math.log("0." + b(u.d)) / Math.LN10 + u.e + 1))) >
          c.maxE + 1 || e < c.minE - 1
          ? new c(0 < e ? o / 0 : 0)
          : ((N = !1),
            (c.rounding = u.s = 1),
            ...
            ((r =
              ...
              E((r = _(r, t + 5, 1)).d, t, s) &&
              +b(
                (r = _(l(n.times(F(u, (e = t + 10) + i)), e), e + 5, 1)).d
              ).slice(t + 1, t + 15) +
                1 ==
                1e14
                ? _(r, t + 1, 0)
      ...
      var i = this,
        ...
        e =
          void 0 === n
            ...
            : (v(n, 1, p),
              void 0 === e ? (e = t.rounding) : v(e, 0, 8),
              M((i = _(new t(i), n, e)), n <= i.e || i.e <= t.toExpNeg, n));
      return i.isNeg() && !i.isZero() ? "-" + e : e;
    }),
      ...
      function (n, e) {
        ...
        return (
          void 0 === n
            ...
            : (v(n, 1, p), void 0 === e ? (e = i.rounding) : v(e, 0, 8)),
          _(new i(this), n, e)
        );
      }),
    (f.toString = function () {
  ...
  var y = function (n, e, i, t, r, s) {
    ...
    for (
      u = s ? ((h = 1), n.e - e.e) : ((s = S), A(n.e / (h = Z)) - A(e.e / h)),
        y = F.length,
        E = D.length,
        p = (O = new q(O)).d = [],
        c = 0;
  ...
  function _(n, e, i, t) {
    ...
    n: if (null != e) {
      ...
      if ((s = e - r) < 0)
        (s += Z), (o = e), (c = ((f = h[(a = 0)]) / w(10, r - o - 1)) % 10 | 0);
      ...
      if (
        (0 == s
          ...
          : ((h.length = a + 1),
            (u = w(10, Z - s)),
            (h[a] = 0 < o ? ((f / w(10, r - o)) % w(10, o) | 0) * u : 0)),
        c)
      )
        for (;;) {
          if (0 == a) {
    ...
    return (
      e
        ? (i && 0 < (t = i - o)
          ...
          (s = s + (n.e < 0 ? "e" : "e+") + n.e))
        : r < 0
        ? ((s = "0." + a(-r - 1) + s), i && 0 < (t = i - o) && (s += a(t)))
        : o <= r
        ? ((s += a(r + 1 - o)),
          i && 0 < (t = i - r - 1) && (s = s + "." + a(t)))
        : ((t = r + 1) < o && (s = s.slice(0, t) + "." + s.slice(t)),
          i && 0 < (t = i - o) && (r + 1 === o && (s += "."), (s += a(t)))),
      s
    );
  }
  function q(n, e) {
  ...
  function J(n, e, i, t) {
    ...
    for (N = !1; ; ) {
      if (
        (i % 2 && nn((s = s.times(e)).d, o) && (r = !0), 0 === (i = A(i / 2)))
      ) {
  ...
  function l(n, e) {
    ...
    for (
      ...
      if (
        ((s = _(s.times(n), c, 1)),
        (i = i.times(++h)),
        b((u = o.plus(y(s, i, c, 1))).d).slice(0, c) === b(o.d).slice(0, c))
      ) {
  ...
  function Q(n, e) {
    ...
    for (
      0 <
      (t = (e = -1 < (i = e.indexOf(".")) ? e.replace(".", "") : e).search(
        /e/i
      ))
      ...
      return (
        ...
        ($.test(n)
          ...
          : function (n, e) {
              var i, t, r, s, o, u, c, f;
              if (-1 < e.indexOf("_")) {
                if (((e = e.replace(/(\d)_(?=\d)/g, "$1")), $.test(e)))
                  return Q(n, e);
              ...
              return s < 0
                ...
                : ((n.e = q(f, e)),
                  ...
                  (N = !1),
                  o && (n = y(n, r, 4 * u)),
                  c && (n = n.times(Math.abs(c) < 54 ? w(2, c) : h.pow(2, c))),
                  (N = !0),
                  n);
            })(r, n)
      );
